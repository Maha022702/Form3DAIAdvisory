      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <h1 className="text-6xl font-extrabold mb-6">
            ...
            <span className="bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">Form3DAdvisory</span>
          </h1>
          ...
          <div className="relative group">
            ...
            <div className="relative bg-gradient-to-br from-cyan-500/10 to-blue-500/10 backdrop-blur-sm border border-cyan-500/20 rounded-3xl p-10">
              ...
              <p className="text-lg leading-relaxed text-gray-300">
                At Form3DAdvisory, we&apos;re on a mission to democratize additive manufacturing in India.
