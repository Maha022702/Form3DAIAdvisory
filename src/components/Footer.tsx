    ...
    <footer className="bg-black border-t border-white/10 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-bold bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">Form3DAdvisory</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-2 text-gray-400">
                ...
                <span>info@form3dadvisory.com</span>
              </li>
              <li className="flex items-start gap-2 text-gray-400">
        ...
        <div className="border-t border-white/10 pt-8 text-center">
          <p className="text-gray-400">&copy; 2026 Form3DAdvisory. All rights reserved.</p>
